...
## elmo <- function(Y, X, w1Y = 0, w2Y = 1, IE = "<=", alpha = 0.05, coefs = 2,
...
##             }
## ### xxxxxx
##         cat("\nBetahatj: ", Betahatj, "\tbetabarj: ", betabarj0, "\ttbar: ", tbarmin, "\n")
##         cat("\ntest statistic: ", Betahatj - betabarj0, "\n")
...
##         cat("\nsigmasq", sigmasqbar_betajOLSvalue, "\n")
##         print(unlist(c(betaj11, tbarmin)))
...
##             }
##         ## cat("sigmasqbarmm: ", sigmasqbar_beta0jmmvalue)
...
##                     {
##                         r <- uniroot(function(x) ((3 * sigmasqbar_beta0jmmvalue-TAUjmm_inf^2) * sigmasqbar_beta0jmmvalue)/((3 * sigmasqbar_beta0jmmvalue-TAUjmm_inf^2) * (sigmasqbar_beta0jmmvalue + x^2) + (x^2-x * TAUjmm_inf-sigmasqbar_beta0jmmvalue)^2) - alpha, c(0,Bhattbarmm))
...
##             }
##         cat("\nsigmasqbarMM TypeII: ", sigmasqbar_betajmmvalue)
...
##                     {
##                         (R <- TAUjmm_inf * sigmasqbar_betajmmvalue/(sigmasqbar_betajmmvalue + (wb1[1])^2)^(3/2))
##                     } else {
##                         (R <- 2 * TAUjmm_inf/((27^0.5) * wb1[1]))
##                     }
